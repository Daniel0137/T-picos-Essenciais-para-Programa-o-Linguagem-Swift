...
Além de Lattner, outros engenheiros tiveram papel importante no desenvolvimento da linguagem. 

Doug Gregor contribuiu principalmente para o sistema de tipos genéricos, protocolos e infraestrutura do compilador. 

John McCall trabalhou no sistema de tipos, na semântica de referência e na integração com Objective-C. 

Ted Kremenek liderou o desenvolvimento do compilador Swift e das ferramentas de análise estática de código. 
